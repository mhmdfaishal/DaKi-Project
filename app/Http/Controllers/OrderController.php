...
class OrderController extends Controller
{
    ...
    public function detailPesanan($id){
        if(Auth::check()){
            ...
            return response()->json(['total_semua_harga'=>$transaksi->total_harga,'alat'=>$alat,'keranjang'=>$barangs,'penyewa'=>$transaksi->user->nama,'alamat'=>$transaksi->toko->alamat,'nama_toko'=>$transaksi->toko->nama_toko,'tanggal'=>$tanggal,'lama_penyewaan'=>$transaksi->total_hari,'status'=>$transaksi->status]);
        }
