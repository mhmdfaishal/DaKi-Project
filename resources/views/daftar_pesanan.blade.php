          ...
          <div class="modal-header">
              ...
              <div class="modal-body">
                <table id="detail-user">
                    ...
                    <tr>
                        <td class="data">Alamat Penyewa</td>
                        <td> : </td>
                        <td class="detail-sewa" id="alamat-user"></td>
                    </tr>
                ...
                <table class="mt-3" id="status-sewa">
                  <tr>
                    <td class="status-form-title">Status</td>
                    <td>:</td>
                    <td class="status-select">
                      <select class="form-select" aria-label="Default select example" id="status">
                        ...
                        <option value="4">Barang Sudah Dikembalikan</option>
                      </select> 
                    </td>
...
@push('scripts')
  ...
  <script src="{{asset('js/daftar-pesanan.js')}}"></script>
@endpush